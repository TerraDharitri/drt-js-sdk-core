...
export { BindOption, Options, ParameterHint, ParameterType, TSConfigReader, TypeDocReader, ArgumentsReader, } from "./lib/utils/options";
export type { OptionsReader, TypeDocOptions, TypeDocOptionMap, KeyToDeclaration, DeclarationOption, DeclarationOptionBase, StringDeclarationOption, NumberDeclarationOption, BooleanDeclarationOption, ArrayDeclarationOption, MixedDeclarationOption, MapDeclarationOption, DeclarationOptionToOptionType, } from "./lib/utils/options";
