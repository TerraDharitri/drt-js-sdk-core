/**
 * The base class for `drtjs` exceptions (errors).
 */
...
/**
 * Signals an invalid DCDT transfer data field
 */
export class ErrInvalidDcdtTransferDataField extends Err {
  public constructor() {
    super("Invalid DCDT transfer call data field");
  }
}
