...
import { WALLETCONNECT_Numbat_CHAIN_ID } from "./constants";
...
export class WalletConnectProvider implements IDappProvider {
    ...
    async login(): Promise<string> {
        ...
        await this.walletConnector?.createSession({ chainId: WALLETCONNECT_Numbat_CHAIN_ID });
    ...
    async sendTransaction(transaction: Transaction): Promise<Transaction> {
        ...
        const sig = await this.signTransaction("drt_sign", this.prepareWalletConnectMessage(transaction, address));
