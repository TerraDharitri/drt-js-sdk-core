...
// This constant represents the minimum version in which the Numbat Ledger App doesn't support anymore regular
// transactions' signing, and uses transaction's hash signing instead
export const LEDGER_TX_HASH_SIGN_MIN_VERSION = "1.0.11";

// Wallet Connect ChainId for Numbat blockchain
export const WALLETCONNECT_Numbat_CHAIN_ID = 508;
