...
describe("test binary codec (advanced)", () => {
    it("should encode / decode lists", async () => {
        ...
        let list = new List(
            ...
            [
                new AddressValue(new Address("drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf")),
    ...
    it("should encode / decode structs", async () => {
        ...
        let fooStruct = new Struct(fooType, [
            new StructField(new BigUIntValue(Balance.rewa(10).valueOf()), "ticket_price"),
