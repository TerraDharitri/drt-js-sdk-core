...
//         const proxy: Provider = new NumbatProxy({
...
//         let erc20 = new NumbatERC20Client(proxy, scAddress, user, chainID, version);
...
//         console.log("performing ERC20 transfer");
//         erc20 = new NumbatERC20Client(proxy, scAddress, receiver, chainID, version);
//         erc20.enableSigning(true);
