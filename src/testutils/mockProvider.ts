...
export class MockProvider implements IProvider {
  static AddressOfAlice = new Address("drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf");
  ...
  constructor() {
    ...
    this.accounts.set(
      ...
      new AccountOnNetwork({ nonce: new Nonce(0), balance: Balance.rewa(1000) })
    );
    this.accounts.set(
      MockProvider.AddressOfBob.bech32(),
      new AccountOnNetwork({ nonce: new Nonce(5), balance: Balance.rewa(500) })
    );
    this.accounts.set(
      MockProvider.AddressOfCarol.bech32(),
      new AccountOnNetwork({ nonce: new Nonce(42), balance: Balance.rewa(300) })
    );
  }
