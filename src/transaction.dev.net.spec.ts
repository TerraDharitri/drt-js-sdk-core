...
describe("test transaction", function () {
    ...
    it("should send transactions", async function() {
        ...
        assert.deepEqual(Balance.rewa(85).valueOf(), newBalanceOfBob.valueOf().minus(initialBalanceOfBob.valueOf()));
    });
