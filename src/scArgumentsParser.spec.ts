...
describe("test scArgumentsParser.isValidDataField", () => {
    it("should return true for valid data fields", () => {
        ...
        assert.isTrue(ScArgumentsParser.isValidSmartContractCallDataField("DCDTTransfer@74657374746f6b656e6964@02b671"));
    });
    ...
    it("should return false for invalid length arguments", () => {
        ...
        assert.isFalse(ScArgumentsParser.isValidSmartContractCallDataField("DCDTTransfer@74657374746f6b656e6964@02b6710"));
    });
    ...
    it("should return false for non-hex arguments", () => {
        ...
        assert.isFalse(ScArgumentsParser.isValidSmartContractCallDataField("DCDTTransfer@74657374746f6b656e6964@02b6710g"));
    });
});
