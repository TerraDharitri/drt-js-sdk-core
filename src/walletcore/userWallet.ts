...
export class UserWallet {
    ...
    /**
     * Copied from: https://github.com/TerraDharitri/dharitricore-js/blob/v1.28.0/src/account.js#L76
     * Notes: adjustements (code refactoring, no change in logic), in terms of: 
     *  - typing (since this is the TypeScript version)
     *  - error handling (in line with drtjs's error system)
    ...
    /**
     * Copied from: https://github.com/TerraDharitri/dharitricore-js/blob/v1.28.0/src/account.js#L42
     * Notes: adjustements (code refactoring, no change in logic), in terms of: 
     *  - typing (since this is the TypeScript version)
     *  - error handling (in line with drtjs's error system)
     *  - references to crypto functions
