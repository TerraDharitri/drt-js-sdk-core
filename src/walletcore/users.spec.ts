...
describe("test user wallets", () => {
    ...
    it("should sign transactions", async () => {
        ...
        let sender = new Address("drt1l453hd0gt5gzdp7czpuall8ggt2dcv5zwmfdf3sd3lguxseux2fsxvluwu");
        let receiver = new Address("drt1cux02zersde0l7hhklzhywcxk4u9n4py5tdxyx7vrvhnza2r4gmqgsejha");
    ...
    it("should sign transactions using PEM files", async () => {
        ...
        let transaction = new Transaction({
            nonce: new Nonce(0),
            value: Balance.Zero(),
            receiver: new Address("drt1cux02zersde0l7hhklzhywcxk4u9n4py5tdxyx7vrvhnza2r4gmqgsejha"),
            gasPrice: new GasPrice(1000000000),
            gasLimit: new GasLimit(50000),
            data: new TransactionPayload("foo"),
            chainID: new ChainID("1")
